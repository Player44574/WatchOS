...
if pomodoroTimerStart=0{
	...
	if point_in_rectangle(mouse_x,mouse_y,24,64,24+32,64+24) and mouse_check_button_pressed(mb_any){if workingHours<23{workingHours+=1}}
	if point_in_rectangle(mouse_x,mouse_y,24+32+24,64,24+32+24+32,64+24) and mouse_check_button_pressed(mb_any){if workingMinutes<59{workingMinutes+=1}}
	if point_in_rectangle(mouse_x,mouse_y,256-24-32,64,256-24-32+32,64+24) and mouse_check_button_pressed(mb_any){if relaxingMinutes<59{relaxingMinutes+=1}}
	if point_in_rectangle(mouse_x,mouse_y,256-24-32-32-24,64,256-24-32-32-24+32,64+24) and mouse_check_button_pressed(mb_any){if relaxingHours<23{relaxingHours+=1}}

	if point_in_rectangle(mouse_x,mouse_y,24,160-24,24+32,160+24-24) and mouse_check_button_pressed(mb_any){if workingHours>0{workingHours-=1}}
	if point_in_rectangle(mouse_x,mouse_y,24+32+24,160-24,24+32+24+32,160+24-24) and mouse_check_button_pressed(mb_any){if workingMinutes>1{workingMinutes-=1}}
	if point_in_rectangle(mouse_x,mouse_y,256-24-32,160-24,256-24-32+32,160+24-24) and mouse_check_button_pressed(mb_any){if relaxingMinutes>1{relaxingMinutes-=1}}
	if point_in_rectangle(mouse_x,mouse_y,256-24-32-32-24,160-24,256-24-32-32-24+32,160+24-24) and mouse_check_button_pressed(mb_any){if relaxingHours>0{relaxingHours-=1}}
}
...
if pomodoroTimerStart=1{
	...
	if fase=0{if inicialTimer>0{inicialTimer--}else{fase=1}}
	if fase=1{if workingTimeLeft>0{workingTimeLeft--}else{fase=2 relaxingTimeLeft=(relaxingHours*3600+relaxingMinutes*60)*room_speed}}
	if fase=2{if relaxingTimeLeft>0{relaxingTimeLeft--}else{fase=1 workingTimeLeft=(workingHours*3600+workingMinutes*60)*room_speed}}
