...
if cloudVersion <= installedVersion{show_debug_message("No update found") canUpdate=0} else if cloudVersion > installedVersion{show_debug_message("Update found!") canUpdate=1}