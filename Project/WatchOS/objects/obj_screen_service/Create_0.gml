if not file_exists(".system/globalConfigs/display.rConfig"){
	...
	ini_write_real("Developer","windowWidth",240);
	ini_write_real("Developer","windowHeight",192);
	ini_close();
}
...
initialWindowWidth=ini_read_real("Developer","windowWidth",240);
initialWindowHeight=ini_read_real("Developer","windowHeight",192);
ini_close();
